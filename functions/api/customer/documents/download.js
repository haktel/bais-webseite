...
import{DOCUMENT_DOWNLOAD_TTL_SECONDS,ensureDocumentUploadSchema,presignDownload}from"../../../_lib/r2-documents.js";
...
export const onRequestGet=async({request,env})=>{
 ...
 try{
  ...
  return json({ok:true,download:{url:downloadUrl,expiresAt,fileName:row.name,mimeType:row.mime_type||null,sizeBytes:row.actual_size||null},requestId:traceId});
