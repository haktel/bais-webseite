...
export const onRequestPost=async({request,env,waitUntil})=>{
 ...
 try{
  ...
  const commercial=await ensureCommercialIdentityForLead(db,{email,displayName:name,company,now});
