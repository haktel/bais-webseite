...
const LESSONS_PER_MODULE={
  ...
  "ki-fuehrerschein":{"modul-01":12,"modul-02":12,"modul-03":12}
};
const LAB_CASES={
  "n8n-bootcamp":{"modul-01":["qualified","standard","invalid"],"modul-02":["single","batch","invalid"],"modul-03":["get","post","invalid"]},
  "ki-fuehrerschein":{"modul-01":["gut","verbesserungswuerdig","blockiert"],"modul-02":["verlaesslich","pruefen","kritisch"],"modul-03":["vollstaendig","teilweise","unzureichend"]}
};
