(()=> {
  const STORAGE={
    last:"bais-kih-m06-last",
    weak:"bais-kih-m06-weak",
    attempt:"bais-kih-m06-attempt"
  };
  ...
  const BANK=[
    q("KIH601","prinzipien","Welches der fünf Grundprinzipien betrifft die Fachverantwortung?","Diagnose und Therapieentscheidung bleiben beim Menschen",["Je unsicherer eine KI-Aussage klingt, desto eher sollte sie übernommen werden","KI trifft Entscheidungen, sobald genug Daten vorliegen","Fachverantwortung entfällt bei Zeitdruck"],"Fachverantwortung bedeutet, dass Diagnose- und Therapieentscheidungen unabhängig vom KI-Einsatz beim Menschen bleiben."),
    q("KIH602","transfer","Welches Prinzip steht laut Modul für ärztliches und therapeutisches Fachpersonal besonders im Vordergrund?","Die Grenze bei klinischen Entscheidungen",["Ausschließlich die Terminplanung","Ausschließlich die Rechnungsstellung","Ausschließlich die Gebäudesicherheit"],"Für ärztliches und therapeutisches Fachpersonal ist die Grenze bei klinischen Entscheidungen der zentrale Schwerpunkt."),
    q("KIH603","vertiefung","Welches vertiefende Programm baut laut Modul auf den Essentials für den Pflegealltag auf?","KI Health Pflege",["KI Health Klinik & Arzt","KI-Führerschein IT & Security","Secure AI & RAG"],"KI Health Pflege vertieft Pflegedokumentation, Übergaben, Patientenkommunikation und Eskalation im Pflegealltag."),
    q("KIH604","vertiefung2","Welches vertiefende Programm richtet sich laut Modul an ärztliches und therapeutisches Fachpersonal?","KI Health Klinik & Arzt",["KI Health Pflege","AI for Sales & B2B Vertrieb","n8n Automation Bootcamp"],"KI Health Klinik & Arzt vertieft klinische Entscheidungsunterstützung, Evidenzrecherche, Arztbriefe und Sorgfaltspflicht."),
    q("KIH605","rotefaden","Auf welche gemeinsame Haltung lassen sich laut Modul alle fünf Prinzipien zurückführen?","KI unterstützt sichtbar und prüfbar, ohne der Fachperson die Verantwortung abzunehmen",["KI übernimmt zunehmend die Verantwortung der Fachperson","KI-Einsatz sollte grundsätzlich vermieden werden","Prüfbarkeit ist bei KI-Einsatz im Gesundheitswesen nicht relevant"],"Der rote Faden aller fünf Prinzipien ist sichtbare, prüfbare Unterstützung ohne Verantwortungsabgabe."),
    q("KIH606","abschluss","Was setzt laut Modul die Teilnahme an einem der vertiefenden Programme (Pflege oder Klinik & Arzt) voraus?","Die in den Essentials gelegten Grundlagen",["Eine separate, unabhängige Zulassung ohne Bezug zu den Essentials","Keine Voraussetzungen","Ausschließlich eine IT-Zertifizierung"],"Beide vertiefenden Programme bauen ausdrücklich auf den in den Essentials gelegten Grundlagen auf."),
  ];
