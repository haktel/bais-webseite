(()=> {
  const STORAGE={
    last:"bais-kihk-m06-last",
    weak:"bais-kihk-m06-weak",
    attempt:"bais-kihk-m06-attempt"
  };
  ...
  const BANK=[
    q("KIHK601","warnsignale","Welches Muster gilt laut Modul als Warnsignal bei einer klinisch relevanten KI-Ausgabe?","Eine ungewöhnlich glatte, sehr sichere Formulierung zu einem eigentlich unsicheren Befund",["Eine Ausgabe, die ihre eigene Unsicherheit deutlich benennt","Eine kurze Antwortzeit des Systems","Eine Antwort mit klarer Quellenangabe, die sich bestätigen lässt"],"Eine überzeugend klingende Formulierung zu einem unsicheren Befund ist ein typisches Warnsignal, das genauer geprüft werden sollte."),
    q("KIHK602","dokumentation","Welche drei Angaben sollten laut Modul bei der Dokumentation einer Auffälligkeit mindestens enthalten sein?","Was aufgefallen ist, wann es aufgefallen ist und welche Situation zugrunde lag",["Nur der Name der verwendeten KI-Software","Nur das Datum, ohne weitere Angaben","Nur eine grobe Einschätzung ohne konkrete Details"],"Was, wann und in welcher Situation sind die drei zentralen Angaben für eine nachvollziehbare Meldung."),
    q("KIHK603","meldeweg","Was ersetzt ein KI-Hinweis auf einen möglicherweise kritischen Befund laut Modul nicht?","Den etablierten klinischen Meldeweg für kritische Befunde",["Die technische Speicherung des Befundes","Die Formatierung des Arztbriefs","Die Terminplanung der Einrichtung"],"Ein KI-Hinweis kann einen Meldeweg allenfalls anstoßen, ihn aber niemals ersetzen."),
    q("KIHK604","fehlerkultur","Was fördert laut Modul eine gesunde Fehlerkultur im Umgang mit KI-Auffälligkeiten?","Melden von Auffälligkeiten ohne Angst vor Schuldzuweisung",["Auffälligkeiten möglichst nicht zu erwähnen","Nur besonders schwerwiegende Fehler zu dokumentieren","Meldungen ausschließlich anonym und ohne jede Nachverfolgung zuzulassen"],"Offenes Melden ohne Angst vor Schuldzuweisung verbessert die Qualität des KI-Einsatzes über die Zeit."),
    q("KIHK605","quelle","Welches Warnsignal betrifft laut Modul die fehlende Nachvollziehbarkeit einer KI-Aussage?","Eine Angabe ohne erkennbare fachliche Grundlage oder Quelle",["Eine Aussage, die auf eine bekannte Leitlinie verweist","Eine Aussage mit Datum und Kontextangabe","Eine kurze, klar als Hinweis gekennzeichnete Antwort"],"Eine Aussage ohne erkennbare Grundlage ist ein klassisches Warnsignal, das besondere Prüfung verdient."),
    q("KIHK606","qualitaet","Wozu dient das systematische Melden von KI-bezogenen Auffälligkeiten laut Modul langfristig?","Um wiederkehrende Probleme im KI-Einsatz systematisch zu erkennen und die Qualität zu verbessern",["Um einzelne Mitarbeitende für Fehler verantwortlich zu machen","Um die Nutzung von KI-Tools grundsätzlich einzuschränken","Um die Meldung ausschließlich an eine externe Behörde weiterzuleiten"],"Ziel ist die kontinuierliche Verbesserung des KI-Einsatzes, nicht die Zuweisung individueller Schuld."),
  ];
