...
const brandLogo=document.querySelector('header .brandLogo');
if(brandLogo){
 brandLogo.src='/assets/bais-logo-concept2.svg?v=4';
 brandLogo.alt='BAIS – IT / AI / Security';
}
...
if(signal){
 signal.outerHTML=`<section class="concept2AfterHero" aria-label="BAIS Einstieg und Arbeitsweise">
  <div class="concept2QuickWrap">
   ...
   <div class="concept2Trust"><div class="concept2TrustRow"><div class="concept2TrustLabel">Technologie-Stack & Integrationen</div><div class="concept2Stack" aria-label="BAIS Technologie-Stack"><span>Cloudflare</span><span>GitHub</span><span>Microsoft</span><span>n8n</span><span>Jira</span><span>Dolibarr</span></div><div class="concept2Assurance"><i></i><span>Sichere Technologie. Stärkere Möglichkeiten.</span></div></div></div>
  </div>
