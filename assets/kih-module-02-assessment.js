(()=> {
  const STORAGE={
    last:"bais-kih-m02-last",
    weak:"bais-kih-m02-weak",
    attempt:"bais-kih-m02-attempt"
  };
  ...
  const BANK=[
    q("KIH201","input","Was verbessert die Qualität eines KI-Entwurfs für einen Pflegebericht am meisten?","Ausreichender Kontext: Rohdaten, Zweck des Textes und gewünschter Ton",["Ein möglichst kurzer, kontextfreier Prompt","Das bewusste Weglassen der Zielgruppe","Eine zufällig gewählte Formulierung"],"Ohne Kontext füllt die KI Lücken mit Vermutungen — klare Angaben zu Fakten, Zweck und Ton verhindern das."),
    q("KIH202","vollstaendigkeit","Warum gelten Auslassungen als unterschätzte Fehlerquelle bei KI-Entwürfen?","Weil ein fehlender Hinweis oft erst später auffällt als ein offensichtlich falscher Wert",["Weil Auslassungen technisch unmöglich sind","Weil KI-Systeme nie etwas auslassen","Weil Auslassungen automatisch von der KI markiert werden"],"Ein sichtbarer Fehler fällt meist sofort auf; eine stillschweigende Auslassung wird leicht übersehen."),
    q("KIH203","pruefung","Welche der folgenden drei Prüffragen gehört zum empfohlenen Check vor der Übernahme?","Ist der Ton für die Zielgruppe passend?",["Wie schnell wurde der Entwurf erstellt?","Wie lang ist der Entwurf insgesamt?","Welches KI-Modell wurde verwendet?"],"Fakten, Vollständigkeit und passender Ton sind die drei zentralen Prüffragen — Geschwindigkeit, Länge oder Modellwahl sind dabei nicht entscheidend."),
    q("KIH204","kommunikation","Was ist beim Vereinfachen oder Übersetzen eines Aufklärungstextes mit KI erlaubt?","Die Sprache zu vereinfachen oder zu übersetzen, ohne neuen medizinischen Inhalt hinzuzufügen",["Fehlende medizinische Details selbstständig zu ergänzen","Den Text ohne erneute fachliche Prüfung direkt weiterzugeben","Eine neue Therapieempfehlung in die vereinfachte Fassung einzufügen"],"Vereinfachen und Übersetzen dürfen die Sprache ändern, aber niemals medizinischen Inhalt hinzufügen oder verändern."),
    q("KIH205","freigabe","Was sollte laut Modul vor der Weitergabe einer übersetzten Patienteninformation geschehen?","Eine fachliche Prüfung der übersetzten Fassung gegen das Original",["Nichts, da Übersetzung als risikofrei gilt","Nur eine Rechtschreibprüfung ist notwendig","Die Freigabe kann vollständig automatisiert erfolgen"],"Gerade bei mehrsprachigen Zielgruppen ist ein Abgleich mit dem Original wichtig, um inhaltliche Abweichungen auszuschließen."),
    q("KIH206","grundregel","Welche Grundregel gilt laut Modul für fehlende Informationen in einem KI-Prompt?","Fehlende Informationen sollten offen bleiben und von der Fachkraft ergänzt werden, statt sie erfinden zu lassen",["Die KI soll plausible Werte selbst ergänzen","Fehlende Informationen können ignoriert werden","Die KI markiert fehlende Informationen automatisch als Diagnose"],"Erfundene Angaben sind eine der größten Risikoquellen bei KI-Entwürfen — Lücken bleiben sichtbar und werden von Menschen geschlossen."),
  ];
